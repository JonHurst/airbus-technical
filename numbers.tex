...
\mysec{Takeoff with tailwind or crosswind > 20kt}{
  \item A319/A320CEO\ref{EOMB 2.3.12}
    \iitem $\bullet$ Set 50\% N1
    \iitem $\bullet$ When engines stable, rapidly set 70\% N1
    \iitem $\bullet$ Select takeoff thrust by 40kt
    \iitem $\bullet$ Stick full forward until 80kt, neutral by 100kt
  \item A320NEO\ref{NEO QRG}
    \iitem $\bullet$ Set 50\% N1
    \iitem $\bullet$ Release brakes
    \iitem $\bullet$ Set 70\% N1
    \iitem $\bullet$ When GS>15kt set FLX or TOGA
}

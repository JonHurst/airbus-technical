...
\item Max start EGT, <35000ft  \ref{LIM.49.10}\dotfill 1090°C
\item Max start EGT, >35000ft \ref{LIM.49.10}\dotfill 1120°C
...
\item Accreted ice  \ref{PRO.SUP.30}
  ...
  \iitem Check landing performance (QRH FPE.IFL.VAP)
\item Accreted ice, wing anti-ice inop \ref{PRO.SUP.30}
  ...
  \iitem Check landing performance (QRH FPE.IFL.30)
}

...
\vbox{\small\subsection{Crosswind Limits}
  \subsubsection{Runway Width $\geq$45m}
  \secref{EOMB 2.1, LIM.22.20, EOMB 4.12.4}
\label{windlimits}
  \begin{center}
\begin{tabular}{|l|c|}\hline
  ...
  \centering Condition}
  & Max Crosswind\\
  ~ & (including gust)\\\hline

  \parbox{0.55\textwidth}{
    \vspace{1mm}
    \begin{compactitem}
     \item Runway: Wet ice
     \item Runway: Water over compacted snow
     \item Runway: Snow over ice
    \end{compactitem}
  ...
  \parbox{0.55\textwidth}{
    \vspace{1mm}
    \begin{compactitem}
     \item\raggedright Rollout: Sharklets
     \item Runway: Ice (cold and dry)
     \item\raggedright Runway: Slippery when wet including portions of poor/unreported
       braking action
    \end{compactitem}
...
\begin{tabular}{|l|c|}\hline
  ...
  \parbox{0.55\textwidth}{
    \vspace{1mm}
    \begin{compactitem}
    \item Failure: Rudder or Rudder Pedal Jam
    \item Failure: Yaw damper system inop
    \item Failure: Rudder travel limiter fault
    \item Failure: Nosewheel steering inop
    \item Failure: One or more brakes inop
    \item Autoland
    \end{compactitem}
    \vspace{1mm}} & Not recommended\\\hline
...
\mysec{Headwind limits}{
  \item Autoland: A319 OEI \ref{LIM.22.20}\dotfill 15kt
  \item Autoland: A319 AEO\ref{LIM.22.20}\dotfill 20kt
  \item Autoland: A320 \ref{LIM.22.20}\dotfill 30kt
  \item otherwise \dotfill No limit
}


\mysec{Tailwind limits}{
  \item Autoland: A319 \ref{NTC OPS 44/16}\dotfill 10kt
  \item otherwise \ref{LIM.12}\dotfill 10kt
}
...
\iitem Wind\dotfill see page \pageref{windlimits}
...
\iitem Sharklet auto rollout with one reverser inop \ref{LIM.22.20}\dotfill Idle
reverse only
\iitem

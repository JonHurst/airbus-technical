...
\vbox{
  \subsection{Standard loading \ref{GHM 2.4.1}}
  \textbf{A319:} Up to 150 bags to Section 41/42, then up to 50 in
  Compartment 5, overspill to Compartment 1.

  \textbf{A320:} Fill Compartment 1 ($\approx$85 bags), remainder to Compartment
  4 and if necessary, Compartment 3. No planned usage of Compartment 5.
}
...
\mysec{Contaminated Runway Operations}{
  ...
  \item Minimum cleared width\ref{WIH 8.2.6} \dotfill 30m (check
    snowbanks\ref{EOMB 4.6.10}) \iitem $\leq$45m does not need to be
...
\item[$\bullet$] \ref{EOMA 8.3.2.9} If GPS is specified as an additional requirement, check RAIM availability.

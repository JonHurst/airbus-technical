...
%% ** Turbulence speeds
\mysec[\secref{PRO.ABN.MISC}]{Turbulence speeds}{
\item A319/A320-CEO
...
\item V$_{MCA}$ (rounded up)\ref{LIM.13}
...
\item V$_{MCG}$ CONF 1+F (rounded up)\ref{LIM.13}
...
\item Oil
  \iitem CFM56 min quantity\ref{EOMB 2.3.4.3}\dotfill 9.5qt+0.5qt/hr
  \iitem LEAP-1A min quantity\ref{NEO QRG}\dotfill 10.6qt+0.45qt/hr
\iitem Max cont temp \dotfill 140°C
\iitem Max trans temp \dotfill 155°C
\iitem Min start temp \dotfill CFM56:-40°C; LEAP-1A:-29°C
...
\item Accreted ice, wing anti-ice inop \ref{PRO.SUP.30}
  \iitem Min speed\dotfill V$_{\mathrm{LS}}$ + 10kt/ G DOT
  \iitem Check landing performance \dotfill QRH PER-C
\item Avoid extended flight in icing conditions with slats extended
  \ref{PRO.SUP.30}
\item CFM56 Fan ice shedding: \ref{EOMB 2.4.91}
...
\item LEAP-1A Fan ice shedding: \ref{NEO OLL}
  \iitem Icing conditions > 60 mins\dotfill 70\% for at least 5 seconds
  \iitem Ground fog icing conditions > 120 mins\dotfill Engineering
  inspection rqd
}
...
\item Conf Full \ref{LIM.13}\dotfill 177kt
  ...
  \subsubsection{A321}
\item Conf 1 \ref{LIM.13}\dotfill 243kt
\item Conf 1+F \ref{LIM.13}\dotfill 225kt
\item Conf 2 \ref{LIM.13}\dotfill 215kt
\item Conf 3 \ref{LIM.13}\dotfill 195kt
\item Conf Full \ref{LIM.13}\dotfill 186kt
}

...
\mysec{RNAV or FINAL APP Non-Precision overlay approach}{
\item[$\bullet$] \textbf{Minimum required equipment:}\\ 1 FMS in GPS
  PRIMARY; 1 MCDU; 1 FD; 1 PFD; ND on PF side; 2 FCU
...
\item[$\bullet$] Chart vs. database \ref{EOMB 2.3.18.3.2}:
  \iitem Max vertical path difference \dotfill 0.1°
  \iitem Max lateral track difference \dotfill APV: 1°; Overlay: 3°

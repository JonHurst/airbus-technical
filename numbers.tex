...
\subsubsection{Runway Width $\geq$45m \ref{EOMB 2.1}}
\begin{center}
\begin{tabular}{|l|c|}\hline
  ...
  \parbox{0.5\textwidth}{
    ...
    \begin{compactitem}
     ...
     \item Compacted Snow (OAT$\leq$-15Â°C)
    \end{compactitem}
    \vspace{1mm}} & 29kt\\\hline
  \parbox{0.5\textwidth}{
    \vspace{1mm}
    \begin{compactitem}
     \item Wet Snow ($\leq$30mm)
     \item Dry Snow ($\leq$130mm)
     \item Compacted Snow (OAT>-15Â°C)
  ...
  \parbox{0.5\textwidth}{
    ...
    \begin{compactitem}
     ...
     \item Water ($\leq$12.7mm)
     \item Slush ($\leq$12.7mm)
    \end{compactitem}

...
\item[$\bullet$] Push V/S at MDA
\item[$\bullet$] Turn 45°
\item[$\bullet$] 30 secs from wings level
...
\item[$\bullet$] Two navigation systems required (2 FMGS + 2 GPS)
...
\item[$\bullet$] Check RAIM availability \& GPS PRIMARY in both \mbox{MCDUs}
  before commencing approach
\item[$\bullet$] Go around for:
\iitem FM/GPS POS DISAGREE
\iitem GPS PRIMARY LOST on both FMGC 
...
\mysec{LVO landing}{
\item[$\bullet$] Check NOTAMS for airport facility downgrades
...
\iitem 50ft, FMA:FLARE\dotfill PNF:``Flare''
